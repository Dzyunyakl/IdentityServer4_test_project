...
namespace Arch.IS4Host {
    public class Startup {
        ...
        private void InitialDatabase (IApplicationBuilder app) {
            using (var serviceScope = app.ApplicationServices.GetService<IServiceScopeFactory> ().CreateScope ()) {
                var presistedDbContext = serviceScope.ServiceProvider.GetRequiredService<PersistedGrantDbContext> ();
                presistedDbContext.Database.Migrate ();
